package gttrade.guantang.com.tradeerp.ZXing.View;
...
/**
 * Created by luoling on 2017/1/3.
 */
...
public class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            // 画扫描框边上的角，总共8个部�?
            paint.setColor(Color.parseColor("#21BDEF"));
    ...
    protected void drawText(Canvas canvas,Rect frame){
        ...
        Rect rect = new Rect();
        String text = "请将二维码/条形码放入框中";
        paint.getTextBounds(text,0,text.length(),rect);
        int viewWidth = getMeasuredWidth();
        int x = (viewWidth-rect.width())/2;
        canvas.drawText(text,
                x, (float) (frame.bottom +(float)TEXT_PADDING_TOP
                        *density), paint);
    }
