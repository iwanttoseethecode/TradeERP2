...
/*
 * SideBar�����ListView�Ҳ����ĸ����View��������Ҫʹ��setTextView(TextView mTextDialog)������������ʾ��ǰ���µ���ĸ��TextView,
 * �Լ�ʹ��setOnTouchingLetterChangedListener���������ûص��ӿڣ�
 * �ڻص�����onTouchingLetterChanged(String s)��������ͬ�Ĳ���
 * 
 * **/
...
public class SideBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < b.length; i++) {
			...
			// ѡ�е�״̬
			if (i == choose) {
				paint.setColor(Color.parseColor("#EEE0E5"));
